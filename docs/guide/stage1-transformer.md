...
**视频课程：**
- 3Blue1Brown《But what is a GPT?》系列（B站有中文字幕）
- Andrej Karpathy《Let's build GPT: from scratch》（YouTube，B站有搬运）
- 李沐《Transformer 论文逐行精读》（B站搜索"李沐 transformer"）
